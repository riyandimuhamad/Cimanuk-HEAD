...
def load_data():
    try:
        df_hujan = pd.read_parquet("master_curah_hujan_ready.parquet")
        df_air = pd.read_parquet("master_duga_air_ready.parquet")
        df_analytics = pd.read_parquet("analytics_results.parquet")
